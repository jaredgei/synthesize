                ...
                <div className='experience'>
                    <div className='flexImage'>
                        <div className='textContainer'>
                            ...
                            <div className='paragraph'><span className='bold'>Working with multiple startups and founding two social ventures</span>, including an open-source zero-electricity structure that filters, cools, and dispenses water to help eliminate plastic waste. So far, we’ve saved over 60,000 plastic water bottles from being used.</div>
